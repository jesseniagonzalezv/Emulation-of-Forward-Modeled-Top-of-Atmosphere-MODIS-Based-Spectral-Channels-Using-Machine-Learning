...
This study presents amachine learning (ML) emulator designed to significantly accelerate the acquisition of satellite observations across 36 spectral channels. Additionally, we generated visible (RGB) satelliteimages from the predictions to qualitatively inspect the models’performance
